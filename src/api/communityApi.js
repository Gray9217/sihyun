...
export async function fetchCommunityPosts() {
  const res = await axios.get(`${API_BASE}/api/community/posts`, { headers: authHeaders() })
...
export async function updateCommunityPost(postId, payload) {
  const res = await axios.put(`${API_BASE}/api/community/posts/${postId}`, payload, {
    headers: authHeaders(),
  })
  return res.data.post
}
...
export async function deleteCommunityPost(postId) {
  const res = await axios.delete(`${API_BASE}/api/community/posts/${postId}`, {
    headers: authHeaders(),
  })
  return res.data
}
...
export async function togglePostLike(postId) {
  const res = await axios.post(`${API_BASE}/api/community/posts/${postId}/like`, null, {
    headers: authHeaders(),
  })
  return res.data
}
...
export async function createPostComment(postId, payload) {
  const res = await axios.post(`${API_BASE}/api/community/posts/${postId}/comments`, payload, {
    headers: authHeaders(),
  })
  return res.data
}
...
export async function createOpinion(payload) {
  const res = await axios.post(`${API_BASE}/api/community/opinions`, payload, {
    headers: authHeaders(),
  })
